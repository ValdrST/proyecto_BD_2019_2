...
begin
    ...
    insert into tarjeta(usuario_id,numero,año_expiracion) 
    ...
    insert into viaje(servicio_id,inicio,fin,folio,aparato_id)
        values (servicio_seq.currval,to_date('30-05-2019 12:00:33','dd-mm-yyyy hh24:mi:ss'),to_date('30-05-2019 12:00:33','dd-mm-yyyy hh24:mi:ss'));
    v_servicio.extend;
    ...
    insert into tarjeta_prepago(tarjeta_prepago_id,usuario_id,codigo_de_barras,fecha_registro,fecha_expiracion,importe) 
        values (usuario_seq.currval,'223149981230971027321',to_date('03-03-2015','dd-mm-yyyy'),to_date('03-03-2020','dd-mm-yyyy'),3000.00);
    v_usuario.extend;
    ...
    insert into ubicacion(ubicacion_id,latitud,longitud,fecha_hora,aparato_id)
        values (ubicacion_seq.nextval,130.000000,30.002300,);
    insert into zona_aparato(zona_aparato_id,zona_id,aparato_id)
        values (zona_aparato_seq.nextval,zona_seq.currval,);
