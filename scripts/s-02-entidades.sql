...
CREATE TABLE TARJETA_PREPAGO(
    TARJETA_PREPAGO_ID NUMBER(10,0) PRIMARY KEY,
...
CREATE TABLE REPORTE(
    REPORTE_ID NUMBER(10,0) PRIMARY KEY,
...
CREATE TABLE IMAGEN_REPORTE(
    IMAGEN_REPORTE_ID NUMBER(10,0) PRIMARY KEY,
    REPORTE_ID NUMBER(10,0) NOT NULL,
    IMAGEN BLOB NOT NULL
);

CREATE TABLE SERVICIO(
    SERVICIO_ID NUMBER(10,0) PRIMARY KEY,
    USUARIO_ID NUMBER(10,0) NOT NULL,
