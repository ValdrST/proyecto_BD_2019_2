...
create table ubicacion(
    ...
    aparato_id number(10,0) not null,
    coordenadas varchar2(81) generated always as (to_char(latitud)||','||to_char(longitud)) virtual,
...
create table tarjeta_prepago(
    ...
    importe number(16,2) default 0 not null,
...
create table viaje(
    ...
    aparato_id number(10,0) not null,
    duracion_viaje number generated always as (fin - inicio) virtual,
