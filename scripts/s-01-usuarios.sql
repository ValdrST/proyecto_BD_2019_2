...
create user gr_proy_admin identified by bravo123 quota 1024 m in users;
create role rol_admin;
create role rol_invitado;
grant create session, create table, create view, create public synonym, create synonym, create sequence, create procedure, create trigger to rol_admin;
